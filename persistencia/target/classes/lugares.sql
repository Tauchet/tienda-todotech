...
INSERT lugar(id, nombre, descripcion, latitud, longitud, estado, fecha_creacion, categoria_id, ciudad_id, usuario_id, horario_id)
VALUES (0,
        "Cabra Loco",
        "Un café rico",
        10.5,
        ...
        (select id from horario where id=0));
INSERT lugar(id, nombre, descripcion, latitud, longitud, estado, fecha_creacion, categoria_id, ciudad_id, usuario_id, horario_id)
VALUES (1,
        "Supermercado",
        "Super descuentos...",
        ...
        (select id from horario where id=1));
INSERT lugar(id, nombre, descripcion, latitud, longitud, estado, fecha_creacion, categoria_id, ciudad_id, usuario_id, horario_id)
VALUES (2,
        "Hamburguis",
        ...
        (select id from horario where id=2));